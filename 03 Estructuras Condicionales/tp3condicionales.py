...
print('Ha ingresado una contraseña correcta') if (long_clave >= 8) and (long_clave <= 14) else print('Por favor, ingrese una contraseña de entre 8 y 14 caracteres')
...
if (media > mediana) and (mediana > moda):
    ...
    print('Distribucion ambigua/asimetrica')
...
print(f'{frase}!') if (ultimo_caracter.lower() in 'aeiou') else print(frase)
...
print('Seleccione una opcion entre 1, 2 o 3.')
print('1: Quiero mi nombre en mayuscula')
print('2: Quiero mi nombre en minuscula')
print('3: Quiero mi nombre con la primera letra en mayuscula')
opcion = int(input())
...
hemisferio = input('Ingrese en cual hemisferio se cuentra (norte/sur): ')
mes = input('Ingrese el mes actual (en numero): ')
